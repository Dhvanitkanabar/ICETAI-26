# 🌾 FasalRakshak — AI-Powered Crop Guardian (ICETAI-26)
...
├── .gitignore                   # Project git ignores
├── package.json                 # Project scripts (install-all, dev)
├── package-lock.json
├── start_all.bat                # Windows setup runner
├── start_all.sh                 # Unix setup runner
├── conflicts.txt                # Resolution history logs
├── debug_output.txt             # Runtime execution diagnostic log
│
